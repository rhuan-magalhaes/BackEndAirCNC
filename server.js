...
async function startDatabase(){
    ...
    const uri = `mongodb+srv://${DB_USER}:${DB_PASS}@clusterapi.j79s3.mongodb.net/${DB_NAME}?retryWrites=true&w=majority&appName=ClusterAPI`;
    ...
    // mongodb+srv://rhuanmagalhaes0801:<db_password>@clusterapi.j79s3.mongodb.net/?retryWrites=true&w=majority&appName=ClusterAPI
